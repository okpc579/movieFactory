...
public class AdminDaoTest {
	...
	public void findRevBlindByUser() {
		System.out.println(dao.findRevBlindByUser(1, "soon1234"));
	}
	//@Test
	public void findRevCmntBlindByUser() {
		System.out.println(dao.findRevCmntBlindByUser(1, "soon1234"));
	}
	...
	public void findRevBlind() {
		...
		//assertThat(dao.findRevBlind().size(), is(3));
	}
	...
	public void findAllEnabledList() {
		System.out.println(dao.findAllEnabledList(1, 10));
		//assertThat(dao.findRevBlind().size(), is(3));
	}
}
